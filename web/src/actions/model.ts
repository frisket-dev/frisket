...
export const ACTION_PLACEMENTS: Partial<Record<string, ActionPlacement>> = {
  'media.ytdlp_download': { tab: 'web', group: 'WEB', order: 0, primary: true },
  'media.fetch_url': { tab: 'web', group: 'WEB', order: 1 },
  'web.capture_page': { tab: 'web', group: 'WEB', order: 2 },
  'web.capture_screenshot': { tab: 'web', group: 'WEB', order: 3 },
  'media.enclosure_materialize': { tab: 'web', group: 'WEB', order: 4 },
  'media.video_frames': { tab: 'video', group: 'VIDEO', order: 0, primary: true },
  'derive.temporal_segments': { tab: 'video', group: 'VIDEO', order: 1 },
  'map.find_visual_cuts': { tab: 'video', group: 'VIDEO', order: 2 },
  'temporal.extract_range': { tab: 'video', group: 'VIDEO', order: 3 },
  'media.extract_faces': { tab: 'video', group: 'VIDEO', order: 4 },
  'media.transcribe': { tab: 'transcripts', group: 'TRANSCRIPTS', order: 0, primary: true },
  'map.find_topic_sections': { tab: 'transcripts', group: 'TRANSCRIPTS', order: 1 },
  'derive.transcript_segments': { tab: 'transcripts', group: 'TRANSCRIPTS', order: 2 },
  'media.ocr': { tab: 'documents', group: 'DOCUMENTS', order: 0, primary: true },
  'media.to_markdown': { tab: 'documents', group: 'DOCUMENTS', order: 1 },
  'media.extract_pdf_tables': { tab: 'documents', group: 'DOCUMENTS', order: 2 },
  'media.extract_metadata': { tab: 'documents', group: 'DOCUMENTS', order: 3 },
  ...
  'map.ask': { tab: 'home', group: 'ANALYZE', order: 0, primary: true },
  'map.summarize': { tab: 'home', group: 'ANALYZE', order: 1 },
  'reduce.group_summary': { tab: 'home', group: 'ANALYZE', order: 2 },
  'map.classify': { tab: 'home', group: 'ANALYZE', order: 3 },
  'map.judge': { tab: 'home', group: 'ANALYZE', order: 4 },
  'map.extract': { tab: 'extract', group: 'EXTRACT', order: 0, primary: true },
  'map.mcp_extract': { tab: 'extract', group: 'EXTRACT', order: 1 },
  'map.ner': { tab: 'extract', group: 'EXTRACT', order: 2 },
  'map.regex_extract': { tab: 'extract', group: 'EXTRACT', order: 3 },
  'map.find': { tab: 'extract', group: 'EXTRACT', order: 4 },
  ...
  'cluster.values': { tab: 'resolve', group: 'RESOLVE', order: 0, primary: true },
  'resolve.substitute': { tab: 'resolve', group: 'RESOLVE', order: 1 },
  'resolve.replace': { tab: 'resolve', group: 'RESOLVE', order: 2 },
  'resolve.combine': { tab: 'resolve', group: 'RESOLVE', order: 3 },
  'resolve.fill_missing': { tab: 'resolve', group: 'RESOLVE', order: 4 },
  'map.translate': { tab: 'language', group: 'LANGUAGE', order: 0, primary: true },
  'frisket.transliterate.transliterate': { tab: 'language', group: 'LANGUAGE', order: 1 },
  ...
  'enrich.geocode': { tab: 'location', group: 'LOCATION', order: 0, primary: true },
  'enrich.census_demographics': { tab: 'location', group: 'LOCATION', order: 1 },
  'map.to_geo_point': { tab: 'location', group: 'LOCATION', order: 2 },
};
...
const GENERATED_CATEGORY_PLACEMENTS: Record<string, ActionPlacement> = {
  ...
  text: { tab: 'home', group: 'ANALYZE', order: 100 },
  extract: { tab: 'extract', group: 'EXTRACT', order: 100 },
};
