// Typed domain handle for the grid-view store. Reads the gridView member off the
...
import type { GridViewStoreHandle } from '../state/gridViewStore';

export function useGridViewHandle(): GridViewStoreHandle {
  return useWorkspaceStores().gridView;
}
